...
urlpatterns = [
    ...
    path('posts/<str:postid>/add_poll/', views.AddPoll.as_view(), name='add-poll'),
    path('posts/<str:postid>/polls/<int:option_id>/vote/', views.VotePoll.as_view(), name='vote-poll'),
    path('posts/<str:postid>/results/', views.PollResults.as_view(), name='poll-results'),
